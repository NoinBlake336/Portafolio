...
const Project = () => {
  ...
  if (isTranslate) {
    designsEn.find((item) =>
      item.title === project ? (object = item) : false
    );
    projectsDataEn.find((item) =>
      item.title === project ? (object = item) : false
    );
  } else {
    projectsDataEs.find((item) =>
      item.title === project ? (object = item) : false
    );
    designsEs.find((item) =>
      item.title === project ? (object = item) : false
  ...
  const { description, img, link, skills, skillsName, span, title, bg } =
    object;
  console.log(bg);
  return (
    <SectionContainerProjectStyled>
      ...
      <ContainerBlockquoteStyled>
        <BlockquoteStyled>{description}</BlockquoteStyled>
      </ContainerBlockquoteStyled>
      <NeonDots />
    </SectionContainerProjectStyled>
  );
